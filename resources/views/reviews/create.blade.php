                    ...
                    <form action="{{ route('reviews.store') }}" method="post">
                        ...
                        <div class="row form-material">
                            ...
                            <div class="col-md-6">
                                ...
                                <select type="text" class="form-control @error('product_id') is-invalid @enderror" id="product_id" name="product_id" value="{{ old('product_id') }}">
                                    ...
                                    <option value="{{$prod->pid}}">{{$prod->product_name}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row form-material">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea type="text" class="form-control @error('description') is-invalid @enderror" id="description" name="description" row="5" value="{{ old('description') }}"></textarea>
                        ...
                        <div class="row form-material mt-3">
                            <input type="submit" class="col-md-3 offset-md-5 btn btn-primary" value="Add Reviews">
                        </div>
                    </form>
                </div>
            </div>
